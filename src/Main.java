   ...
   public class  PanoCallable implements Callable<String> {
    ...
    public static void main(String[] args) {
      //  ExecutorService executorService= Executors.newFixedThreadPool(3);
       // FutureTask<String> result=executorService.submit(new PanoCallable("d://sphere.jpg",DirectionEnum.TOP));
        ...
        try {
            ...
            ImageIO.write(frontImage, "png",new File("d://cube_front.png"));
            ImageIO.write(rightImage,"png",new File("d://cube_right.png"));
            ImageIO.write(backImage,"png",new File("d://cube_back.png"));
            ImageIO.write(leftImage,"png",new File("d://cube_left.png"));
            ImageIO.write( topImage,"png",new File("d://cube_top.png"));
            ImageIO.write( bottomImage,"png",new File("d://cube_bottom.png"));
